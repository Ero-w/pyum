...
class user extends common{
	...
	function public_action(){
		...
		if($_GET['c']==''){
			...
			$this->yunset("left",5);
		}elseif($_GET['c']=='setname'||$_GET['c']=='fav_subject'||$_GET['c']=='fav_agency'||$_GET['c']=='subject_zixun'||$_GET['c']=='baoming_subject'||$_GET['c']=='passwd'||$_GET['c']=='binding'||$_GET['c']=='message'||$_GET['c']=='seemessage'||$_GET['c']=='sysnews'||$_GET['c']=='xin'||$_GET['c']=='pl'||$_GET['m']=='ask'||$_GET['c']=='atn_teacher'){ 
			$this->yunset("left",6);
		}
	}
